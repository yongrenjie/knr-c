...
int main (int argc, char *argv[])
{
    ...
    /* parse arguments */
    int a = parseargs(argc, argv, &numeric, &reverse); /* in practice there are libraries that do this. look up getopt() */
    if (a) {
...
int parseargs (int argc, char **argv, int *numeric, int *reverse)
{
    if (argc > 1) {
        char c;
        while (--argc) {
